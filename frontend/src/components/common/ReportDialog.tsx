...
const ReportDialog: React.FC<ReportDialogProps> = ({ open, onClose, targetId, type, onSuccess }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post('/api/users/report', payload);
      setSuccess(true);
          ...
          <Box sx={{ mt: 1 }}>
            ...
            <FormControl component="fieldset" sx={{ mb: 2 }}>
              ...
              <RadioGroup value={reason} onChange={(e) => setReason(e.target.value)}>
                <FormControlLabel value="spam" control={<Radio />} label="Spam / Misleading" />
                <FormControlLabel value="fraud" control={<Radio />} label="Fraud / Scam" />
