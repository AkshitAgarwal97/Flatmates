...
-F "title=Schema Fixed Property" ^
-F "description=Verification of backend listingType fix and schema fix." ^
-F "propertyType=apartment" ^
-F "listingType=entire_property" ^
-F "price={\"amount\": 4000}" ^
-F "address={\"street\":\"456 Schema St\",\"city\":\"New York\",\"state\":\"NY\",\"zipCode\":\"10001\",\"country\":\"USA\"}" ^
-F "availability={\"availableFrom\":\"2026-02-01\"}"
