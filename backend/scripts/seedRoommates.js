...
const seedRoommates = async () => {
    try {
        await mongoose_1.default.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/flatmates');
        console.log('MongoDB Connected');
        // Delete existing demo users to avoid duplicates
        await User_1.default.deleteMany({ email: { $regex: 'demo@example.com' } });
        console.log('Cleared existing demo users');
        await User_1.default.insertMany(mockRoommates);
...
seedRoommates();
//# sourceMappingURL=seedRoommates.js.map