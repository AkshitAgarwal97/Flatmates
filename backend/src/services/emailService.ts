...
export const sendOTPEmail = (email: string, otp: string) => emailServiceInstance.sendOTPEmail(email, otp);
export const generateOTP = () => emailServiceInstance.generateOTP();
